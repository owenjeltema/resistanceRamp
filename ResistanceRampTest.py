# add significance testing that Haarsma wanted
# read in files and itterate, and putting results into results folder. (good quality of life improvements.)
...
def averageI(list, amount):
    ...
    for x in indexList:
        ...
        # print("step current",mean(holdlist))
...
# Brings in the file
# abf = pyabf.ABF("23623002.abf")
# plt.figure(figsize=(8, 5))  # this might not need to be here

# iterate through all files within directory that IDE is currently within. Set path to be wherever dataset is.
